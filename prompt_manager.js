...
-⚠️这一行只能包含兴趣/饮食/沟通/禁忌,严禁出现年龄、职业、重要记忆、新信息等字段！
...
⚠️操作规范:
-首次记录某类型:使用insertRow(8, {0: "信息类型名称", 1: "记录时间", 2: "该类型的具体内容"})
-更新已有类型:必须先检查表8中是否已有该类型的记录,若存在则使用updateRow(8, 行索引, {1: "更新时间", 2: "完整的更新后内容"})
-⚠️严禁混淆类型:绝对不允许在一行中混入其他类型的字段！"基础信息"行不能出现"饮食"、"重要记忆"等字段！
-⚠️严禁跨类型合并:错误示例:"年龄:20岁;饮食:喜欢榴莲;职业:产品经理" ← 这是3个类型混在一起！
-✅正确做法:
  insertRow(8, {0: "基础信息", 1: "2024-01-20 10:00", 2: "年龄:20岁"})
  insertRow(8, {0: "偏好习惯", 1: "2024-01-20 10:05", 2: "饮食:喜欢榴莲"})
  后续新增职业时 → updateRow(8, 0, {1: "2024-01-21 15:00", 2: "年龄:20岁;职业:产品经理"})
