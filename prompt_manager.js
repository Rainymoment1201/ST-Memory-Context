...
【表8填写详细规则】
⚠️核心原则:同一信息类型(如基础信息)在表8中只能有一条记录！更新时必须先检查该类型是否已存在,若存在则使用updateRow更新整条记录,严禁重复记录相同信息！

1️⃣基础信息:
-内容:姓名、昵称、性别、年龄、生日、职业、居住地、星座等.
-格式:分号分隔,如"姓名:张三;昵称:小三;性别:男;年龄:25;生日:1999-05-20;职业:程序员;居住地:北京;星座:金牛座"
-⚠️去重规则:更新时必须保留已有信息,只修改变化的字段.例如已有"年龄:20岁",新增"职业:产品经理"时,应输出"年龄:20岁;职业:产品经理",而非单独"职业:产品经理"！

2️⃣个人特质:
-内容:{{user}}的性格特点、特殊技能、兴趣爱好.
-格式:分号分隔,如"性格:外向开朗;技能:会弹吉他,擅长烹饪;爱好:摄影,旅行"
-⚠️去重规则:新增爱好时,必须保留已记录的爱好,如已有"爱好:摄影",新增"旅行"时应为"爱好:摄影,旅行"！

3️⃣偏好习惯:
-内容:日常偏好、饮食习惯、沟通风格、禁忌事项.
-格式:分号分隔,如"兴趣:看悬疑小说;饮食:不吃香菜,喜欢甜食;沟通:喜欢直接表达;禁忌:对花生过敏"
-重点:禁忌事项必须明确记录！如"对XX过敏"、"不能吃XX"、"讨厌XX".
-⚠️去重规则:已有"饮食:喜欢榴莲",再提到喜欢榴莲时,不要重复记录"饮食:喜欢榴莲;饮食:喜欢榴莲"！新增其他食物偏好时才追加,如"饮食:喜欢榴莲,爱吃火锅"！
...
⚠️操作规范:
-首次记录某类型:使用insertRow(8, {0: "信息类型", 1: "记录时间", 2: "具体内容"})
-更新已有类型:必须先检查表8中是否已有该类型的记录,若存在则使用updateRow(8, 行索引, {1: "更新时间", 2: "完整的更新后内容"})
-⚠️严禁重复:绝对不允许对同一类型重复使用insertRow！例如"基础信息"已存在第0行,再次更新基础信息时必须用updateRow(8, 0, {...}),而非insertRow创建新行！
-内容合并原则:updateRow时,新内容必须包含旧内容+新增内容,不要丢失已记录的信息.例如已有"年龄:20岁;饮食:喜欢榴莲",新增职业时应为"年龄:20岁;饮食:喜欢榴莲;职业:产品经理"！
