...
-字段说明:
  ①基础信息:姓名、昵称、性别、年龄、生日、职业(含工作/职位)、居住地、星座等
  ②个人特质:性格、技能、爱好等
  ③偏好习惯:兴趣爱好(如喜欢蓝色/喜欢萨摩耶)、饮食偏好、沟通方式、禁忌事项等 (严禁包含宠物！)
  ④人际关系:家人、朋友、宠物(养XX/有只XX)、其他关系等 (所有宠物信息必须在此！)
  ⑤重要时刻:重要经历、约定事项、重要时间点(第一次见面等,必须包含日期)
...
-🚨关键分类规则:
  →基础信息:姓名/昵称/性别/年龄/生日/职业/工作/职位/居住地/星座
  →偏好习惯:喜欢某物/兴趣爱好/饮食偏好/禁忌/过敏 (严禁包含宠物！)
  →人际关系:家人/朋友/养宠物/父母/孩子/配偶 (所有"养XX"/"有只XX"都属于这里！)
  →重要时刻:第一次XX/毕业/结婚/换工作日期/重要经历(必须包含具体日期)
-🚨特别注意:
  →"喜欢萨摩耶"(偏好) ≠ "养了只萨摩耶"(人际关系)
  →"喜欢蓝色"属于"偏好习惯",不是"人际关系"
...
🚨🚨🚨【updateRow强制去重流程】🚨🚨🚨
当使用updateRow更新表8某一行时,必须严格遵守以下流程:
1️⃣读取该行当前内容
2️⃣解析出所有字段(如"昵称:XX;年龄:XX;职业:XX")
3️⃣检查新信息是否已存在于某个字段中
  →若已存在且内容相同→跳过该信息
  →若已存在但内容不同→更新该字段
  →若不存在→添加该字段
4️⃣合并所有字段,确保每个字段名只出现一次
5️⃣重写整行内容

❌严禁操作:直接在原内容后面追加,导致字段重复！
  错误示例: "昵称:小池;昵称:小池;昵称:小池;昵称:小池" ← 重复4次！

✅正确操作:
  原内容: "昵称:小池;年龄:20"
  新信息: "喜欢蓝色"
  步骤: ①读取→②解析[昵称:小池,年龄:20]→③新信息"喜欢蓝色"不存在→④合并
  结果: updateRow(8, 0, {2: "昵称:小池;年龄:20;兴趣:喜欢蓝色"}) ← 每个字段只出现一次

-✅正确示例:
  场景1: 已有"基础信息"行,内容为"昵称:小池;年龄:20",现在要添加"职业:产品经理"
    →读取: "昵称:小池;年龄:20"
    →检查: "职业:产品经理"不存在
    →合并: updateRow(8, 0, {2: "昵称:小池;年龄:20;职业:产品经理"})
    ❌错误: updateRow(8, 0, {2: "昵称:小池;年龄:20;昵称:小池;职业:产品经理"}) ← 昵称重复！

  场景2: 已有"偏好习惯"行,内容为"饮食:喜欢山竹",现在要添加"喜欢榴莲"
    →读取: "饮食:喜欢山竹"
    →检查: "饮食"字段已存在
    →合并到同一字段: updateRow(8, 1, {2: "饮食:喜欢山竹,喜欢榴莲"})
    ❌错误: updateRow(8, 1, {2: "饮食:喜欢山竹;饮食:喜欢榴莲"}) ← 字段名重复！

  场景3: 用户又说"我昵称是小池",但该信息已存在
    →读取: "昵称:小池;年龄:20;职业:产品经理"
    →检查: "昵称:小池"已存在且内容相同
    →结果: 跳过,不执行任何操作 ← 严禁重复记录！

  用户说"我喜欢蓝色,还喜欢萨摩耶,养了只白色小比熊犬"
    →分类判断:
      ①"喜欢蓝色"和"喜欢萨摩耶"→"偏好习惯"(兴趣)
      ②"养了只白色小比熊犬"→"人际关系"(宠物)
    →执行操作:
      insertRow(8, {0: "偏好习惯", 1: "2024-01-20 10:10", 2: "兴趣:喜欢蓝色,喜欢萨摩耶"})
...
-❌错误示例(必须避免):
  ...
  ❌错误2-宠物分类错误:
    insertRow(8, {0: "偏好习惯", 2: "兴趣:喜欢蓝色;宠物:养了只比熊犬"}) ← 宠物不属于偏好习惯！
  ...
  ❌错误5-updateRow导致字段重复(最常见错误):
    原内容:"昵称:小池;喜欢颜色:蓝色"
    错误操作:直接追加 → "昵称:小池;喜欢颜色:蓝色;昵称:小池;喜欢颜色:蓝色" ← 全部重复！
    正确操作:先去重再合并 → "昵称:小池;喜欢颜色:蓝色;饮食:喜欢榴莲" ← 只添加新字段

  ❌错误6-同一字段值重复:
    updateRow(8, 0, {2: "饮食:喜欢榴莲;饮食:喜欢榴莲"}) ← 同一字段重复2次！

  ✅正确做法:
    insertRow(8, {0: "偏好习惯", 2: "兴趣:喜欢蓝色,喜欢萨摩耶"}) ← 逗号分隔,只写一次
    insertRow(8, {0: "人际关系", 2: "宠物:养了只白色小比熊犬"}) ← 宠物独立记录
    updateRow时必须去重: "昵称:小池;年龄:20" + "职业:产品经理" = "昵称:小池;年龄:20;职业:产品经理" ← 无重复
